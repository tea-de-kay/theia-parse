...
### type = 'image'
- content: Detailed description of the image using the same language as the main page text. For diagrams, include the numeric data and a detailed description of the diagram. If the image only contains text or a table, create an appropriate content block of the respective type.
...
* Image analysis: Include all relevant images like photos, sketches and diagrams. Exclude logos, icons, decorative elements and text- or table-only images.
